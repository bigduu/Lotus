  ...
  translation: {
    ...
    inspector: {
      ...
      workflowRuns: {
        title: "Workflow runs",
        refresh: "Refresh",
        unavailable: "Workflow progress is temporarily unavailable.",
        out_of_sync: "Workflow progress is resynchronizing after an event sequence mismatch.",
        planTree: "Workflow plan progress",
        ...
        wallTimeLimit: "Wall-time limit",
        cancel: "Cancel run",
        cancelFailed: "Cancellation was not confirmed. The authoritative run state was refreshed.",
        status: {
          queued: "Queued",
          running: "Running",
          suspended: "Suspended",
