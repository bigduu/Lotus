  ...
  translation: {
    ...
    inspector: {
      ...
      workflowRuns: {
        title: "Workflow 运行",
        refresh: "刷新",
        unavailable: "Workflow 进度暂时不可用。",
        out_of_sync: "检测到事件序列不一致，正在重新同步 Workflow 进度。",
        planTree: "Workflow 计划进度",
        runtimeInstances: "运行时实例",
        ...
        nestingLimit: "嵌套上限",
        wallTimeLimit: "运行时长上限",
        cancel: "取消运行",
        cancelFailed: "尚未确认取消；已重新读取后端权威运行状态。",
        status: {
          queued: "排队中",
          running: "运行中",
          suspended: "已挂起",
    ...
    chat: {
      ...
      project: {
        ...
        pathLabel: "项目文件夹",
        pathDescription: "该项目的主要源码目录和默认工作区；创建后可以继续绑定多个工作区。",
        ...
        selectForSession: "选择项目",
        sessionModalTitle: "指定会话所属项目",
        sessionModalDescription: "选择拥有此会话的项目，并从项目已绑定的工作区中选择执行目录。",
        assignNoProjects: "没有已配置主工作区的活动项目。可在此创建项目，再绑定所需的其他工作区。",
        assignProjectLoadFailed: "加载此项目的工作区失败",
        assign: "指定",
        assignmentSuccess: "会话项目已更新",
        assignmentFailed: "更新会话项目失败",
        assignmentRevisionConflict: "此会话已在服务器上发生变化，请重新打开项目选择器后再试。",
        assignmentRunningConflict: "此会话正在运行或启动中，请先停止，再更改所属项目。",
        assignmentArchived: "所选项目已归档，请选择活动项目。",
        assignmentUnavailable: "所选项目不可用，请刷新项目后重试。",
        assignmentPathUnavailable: "所选项目需要先配置可用的主文件夹，才能归属此会话。",
        assignmentWorkspaceConflict: "会话目录与所选项目冲突，无法应用该项目的主文件夹。",
        childProjectInherited: "子会话继承根会话的项目；请打开根会话进行更改。",
        loadFailed: "加载项目失败",
      },
      migration: {
        entry: "迁移旧会话",
      ...
      contextBar: {
        project: "项目",
        projectTooltip: "会话项目：{{name}}。点击可更改。",
        workspace: "工作区",
    ...
    settings: {
      ...
      permissionsTab: {
        ...
        denies: "拒绝规则",
        otherRules: "其他策略规则",
        temporaryGrants: "临时 / 会话授权",
        policyRevision: "策略版本 {{revision}}",
        refresh: "刷新",
        ...
        saveSuccess: "权限规则已保存",
        saveFailed: "保存权限规则失败",
        typedAlwaysAsk: "Typed 强制确认规则",
        noTypedAlwaysAsk: "暂无 typed 强制确认规则。",
        noRememberedAllows: "暂无已记住的允许规则。",
        noDenies: "暂无已记住的拒绝规则。",
        noOtherRules: "暂无其他策略规则。",
        noTemporaryGrants: "暂无活跃的临时授权。",
        grantScopes: {
          unscopedSession: "旧版会话",
          session: "会话",
          oneShot: "单次",
        },
        grantEffects: {
    ...
    components: {
      ...
      questionDialog: {
        ...
        autoStillAsked: "Auto 模式已开启，但该操作仍必须确认。",
        matchedRule: "命中规则",
        suggestedMatchers: "作用域匹配器",
        expandResource: "显示完整资源",
        collapseResource: "收起资源",
        ...
        confirmScopes: {
          ...
          allow_workspace: {
            ...
            description: "该匹配器只会在下方 workspace 中放行，请确认后再保存。",
          },
          allow_global: {
            title: "全局记住权限？",
            description: "强提醒：撤销前，该匹配器会在所有 workspace 中持续放行。",
          },
        },
      },
      skillManager: {
