  ...
  translation: {
    ...
    chat: {
      ...
      project: {
        ...
        initialWorkspaceLabel: "Initial workspace (optional)",
        create: "Create",
        ...
        restoreUnavailable: "Restore needs backend support (Bamboo-agent#725)",
        workspacesTitle: "Bound workspaces",
        addWorkspace: "Bind",
        ...
        emptyWorkspaces: "No workspaces bound yet",
