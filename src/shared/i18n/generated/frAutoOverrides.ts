export const frAutoOverrides = {
  ...
  "chat": {
    "workspace": {
      ...
      "descriptionP1": "Définissez un chemin d'accès à l'espace de travail afin que les références de fichiers et les outils de l'espace de travail puissent résoudre les fichiers de manière fiable.",
      "descriptionP2": "Choisissez un dossier de projet existant. Vous pouvez toujours continuer avec un chemin non valide, mais les fonctionnalités associées risquent de ne pas fonctionner correctement.",
    ...
    "input": {
      ...
      "autoPrefixMode": "Mode de préfixe automatique : {{prefix}} (tapez « / » pour sélectionner les outils)",
  ...
  "settings": {
    ...
    "systemPromptManager": {
      ...
      "defaultPromptLocked": "Les invites système par défaut sont verrouillées et ne peuvent pas être modifiées.",
    ...
    "envVars": {
      ...
      "description": "Les variables sont injectées dans les processus de l'outil Bash. Les variables secrètes sont chiffrées au repos.",
      ...
      "nameInvalid": "Doit commencer par une lettre ou un trait de soulignement, suivi de lettres, de chiffres ou de traits de soulignement",
      ...
      "secretHint": "Les variables secrètes sont chiffrées sur le disque et masquées dans l'interface utilisateur",
    ...
    "providerTab": {
      ...
      "fastModelHelp": "Modèle moins cher/plus rapide pour les tâches légères telles que la génération de titres, la correction de sirène et la synthèse. Utilise le modèle par défaut lorsqu'il n'est pas défini.",
      "visionModel": "Modèle de vision (facultatif)",
      "visionModelHelp": "Modèle capable de vision pour la compréhension des images. Lorsque hooks.image_fallback.mode est défini sur « vision », ce modèle décrit les images sous forme de texte afin que les modèles contenant uniquement du texte puissent les comprendre. Utilise le modèle par défaut lorsqu'il n'est pas défini.",
